...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        @if (Auth::user()->rol == 1 ||
            ...
            @if (Auth::user()->hasPermiso('comensales') || Auth::user()->hasPermiso('entradas'))
                <li class="nav-item">
                    <a class="nav-link {{ url()->current() == route('admin.comensales.index') || url()->current() == route('admin.entradas.index') ? 'collapse show' : 'collapsed' }}"
                        ...
                        <i class="bi bi-people fs-3"></i><span>Comensales</span><i
            ...
            @if (Auth::user()->rol == 1 ||
                    Auth::user()->hasAnyPermiso(['servicios', 'sincronizar', 'users', 'roles', 'permisos', 'torniquetes', 'atms']))
                <li class="nav-item">
